...
export class BabylonSkater {
    ...
    spawn(config = {}) {
        ...
        const aggregate = new BABYLON.PhysicsAggregate(
            ...
            { 
                ...
                friction: 0.2       // Low friction for skating
            },
            this.scene
        );
        ...
        aggregate.body.setLinearDamping(0.05); // Very low for skating momentum
    ...
    /**
     * Apply movement (velocity-based for smooth skating)
     */
    moveForward(speed = 0.5) {
        ...
        if (horizontalSpeed < 30) { // Max speed limit
