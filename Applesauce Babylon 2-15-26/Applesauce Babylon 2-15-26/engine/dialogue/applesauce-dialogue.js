...
export class ApplesauceDialogue {
    ...
    /**
     * Shows a simple dialogue message programmatically (bypasses NPC system)
     * Useful for level events, system messages, etc.
     * @param {string} speaker - Name to display as speaker
     * @param {string} message - Text to display
     */
    show(speaker, message) {
        // Format as dialogue array
        const dialogueArray = [
            { speaker: speaker, text: message }
        ];
        
        // Start the dialogue
        this.start(dialogueArray);
    }
