...
// THREE is already loaded globally in the HTML, so we can just use it
// If your setup requires importing, use: import * as THREE from 'three';
...
export class ApplesauceMaterials {
    ...
    // List all available materials (helpful for debugging)
    listMaterials() {
