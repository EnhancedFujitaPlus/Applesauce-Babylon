...
### Floor Boundaries
- X-axis: **-20 to +20** (40 units total)
- Z-axis: **-20 to +20** (40 units total)
- Y-axis: **floorNum × 5** (floor height)

### Important Positions
- **Elevator location**: (0, floorY, 18) - always at north side
- **Center of floor**: (0, floorY, 0)

### Direction Reference
- **North** = Positive Z (toward +20)
- **South** = Negative Z (toward -20)
- **East** = Positive X (toward +20)
- **West** = Negative X (toward -20)
